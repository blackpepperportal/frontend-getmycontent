...
const EditProfileLoader = (props) => (
  ...
  >
    ...
    <circle cx="23" cy="171" r="17" /> 
    <rect x="65" y="164" rx="0" ry="0" width="111" height="13" /> 
    <rect x="6" y="199" rx="0" ry="0" width="244" height="5" /> 
    <circle cx="25" cy="235" r="17" /> 
    <rect x="67" y="228" rx="0" ry="0" width="111" height="13" /> 
    <rect x="8" y="263" rx="0" ry="0" width="244" height="5" /> 
    <circle cx="26" cy="298" r="17" /> 
    <rect x="68" y="291" rx="0" ry="0" width="111" height="13" /> 
    <rect x="9" y="326" rx="0" ry="0" width="244" height="5" /> 
    <circle cx="28" cy="362" r="17" /> 
    <rect x="70" y="355" rx="0" ry="0" width="111" height="13" /> 
    <rect x="11" y="390" rx="0" ry="0" width="244" height="5" /> 
    <circle cx="26" cy="424" r="17" /> 
    <rect x="68" y="417" rx="0" ry="0" width="111" height="13" /> 
    <rect x="9" y="452" rx="0" ry="0" width="244" height="5" /> 
    <circle cx="28" cy="488" r="17" /> 
    <rect x="70" y="481" rx="0" ry="0" width="111" height="13" /> 
    <rect x="11" y="516" rx="0" ry="0" width="244" height="5" />
  </ContentLoader>
)
