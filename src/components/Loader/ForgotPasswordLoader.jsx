...
const ForgotPasswordLoader = (props) => (
  ...
  >
    ...
    <rect x="10" y="21" rx="5" ry="5" width="272" height="412" /> 
    ...
    <rect x="330" y="350" rx="25" ry="25" width="273" height="51" /> 
    <rect x="409" y="415" rx="0" ry="0" width="135" height="5" /> 
    <rect x="386" y="435" rx="0" ry="0" width="183" height="8" />
  </ContentLoader>
)
