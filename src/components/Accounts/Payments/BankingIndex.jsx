                        ...
                        <Col sm={12} md={12}>
                            ...
                            <div className="banking-body">
                                <Form className="banking-personal-form">
                                    ...
                                    <h4>Fill in your legal name, address and attach your goverment issued picture ID</h4>
                                    ...
                                    <Form.Group controlId="formBasicEmail">
                                        ...
                                        <Form.Control type="email" value="United Kingdom" placeholder="" />
                                        <Form.Text className="text-muted">
                                            If you would like to change your country please contact <Link to="#">customer support</Link>
                                        </Form.Text>
                                    </Form.Group>
                                    <Form.Group controlId="formBasicEmail">
                                    ...
                                    <Form.Group controlId="formBasicEmail">
                                        <Form.Label>Twitter <span>(optional)</span></Form.Label>
                                        <Form.Control type="lname" placeholder="Your username" />
                                    </Form.Group>
                                    <Form.Group controlId="formBasicEmail">
                                        <Form.Label>Instagaram <span>(optional)</span></Form.Label>
                                        <Form.Control type="lname" placeholder="Your username" />
                                    </Form.Group>
                                    <Form.Group controlId="formBasicEmail">
                                    ...
                                    <Form.Group controlId="formBasicEmail">
                                        <Form.Label>Date Of Birth<span>(optional)</span></Form.Label>
                                    ...
                                    <Form.Row>
                                        ...
                                        />
                                                <Form.Text className="text-muted">
                                                    Please upload a photo of your picture ID Document (i.e. Passport or Driving License)
                                        </Form.Text>
                                            </Form.Group>
                                        </Col>
                                        <Col sm={4}>
                                    ...
                                    <Form.Row>
                                        ...
                                        />
                                                <Form.Text className="text-muted">
                                                    Please upload a photo of your picture ID Document (i.e. a selfie ensuring your face is clearly visible)
                                        </Form.Text>
                                            </Form.Group>
                                        </Col>
                                        <Col sm={4}>
                                    ...
                                    <Form.Group controlId="formBasicEmail">
                                        <Form.Label>ID Expiration Date <span>optional</span></Form.Label>
                                        <Form.Control type="address" placeholder="ID expiration date" />
                                    </Form.Group>
                                    <Form.Group>
                                        {["radio"].map((type) => (
                                    ...
                                    <Form.Group>
                                        <Form.Label className="mb-4 mt-2">Explicity Content<span>(optional)</span></Form.Label>
                                        {["radio"].map((type) => (
                                            <div key={`custom-inline-${type}`}>
                                                <Form.Check
                                                    custom
