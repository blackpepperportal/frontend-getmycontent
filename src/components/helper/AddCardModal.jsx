                        ...
                        <div className="add-card-content-header">
                            ...
                            <div className="flex-center">
                                <ul className="list-unstyled">
                                    <Media as="li">
                                        <i class="fas fa-check mr-2"></i><span>Full access to this user's content</span>
                                    </Media>
                                    <Media as="li">
                                        <i class="fas fa-check mr-2"></i><span>Direct message with this user</span>
                                    </Media>
                                    <Media as="li">
                                        <i class="fas fa-check mr-2"></i><span>Cancel your subscription at any time</span>
                                    </Media>
                                </ul>
                            </div>
